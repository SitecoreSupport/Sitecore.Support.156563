...
namespace Sitecore.Support.ExperienceEditor.LockAndEdit
{
    public class EnsureWorkflowState
    {
        ...
        {
            "/-/speak/request/v1/expeditor/ExperienceEditor.LockItem",
            "/-/speak/request/v1/expeditor/ExperienceEditor.Save.CallServerSavePipeline",
            "/-/speak/request/v1/expeditor/ExperienceEditor.AddVersion.Execute"
        };
